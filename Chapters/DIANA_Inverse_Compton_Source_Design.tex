...
\end{equation}
To get an order of magnitude estimate for the specific activity for the photonuclear production of $^{153}\mathrm{Sm}$ using DIANA, the assumption that all of the flux ($\mathcal{F} = 6.04\times 10^{10}$~ph/\si{\second}) is concentrated at the peak photonuclear cross section is made. This overestimate bounds the maximal possibility of using the DIANA ERL ICS as a generator for medical isotopes. The specific activity as a function of irradiation time for $^{153}\mathrm{Sm}$ is shown in Fig.~\ref{fig:153Sm_specific_activity}.
\begin{figure}[!h]
\centering
\includegraphics[width=0.6\textwidth]{Figures/DIANA_Inverse_Compton_Source_Design/154Sm_specific_activity.pdf}
\caption{Estimated specific activity of the produced $^{153}\mathrm{Sm}$ as a function of irradiation time assuming the full flux of the DIANA ICS source at the peak photoneutron reaction cross section measured by Carlos et al \cite{carlos1974giant} (red) and Filipescu et al \cite{filipescu2014photoneutron} (blue).}
\label{fig:153Sm_specific_activity}
\end{figure}

As shown in Fig.~\ref{fig:153Sm_specific_activity}, within 300-400 hours of irradiation the specific activity of the sample reaches a maximum of 5.95~\si{\mega\becquerel}/\si{\milli\gram} (Carlos et al \cite{carlos1974giant}) and 5.32~\si{\mega\becquerel}/\si{\milli\gram} (Filipescu et al \cite{filipescu2014photoneutron}). However, due to irradiation time constraints, the radioisotopic sample will not achieve the maximal specific activity. Considering the assumptions of peak cross section and that the full uncollimated flux is impinging on the $^{154}\mathrm{Sm}$ target, the specific activity is likely to be much lower. For example, for iradiation with a 0.5\% \textit{rms} bandwidth DIANA ICS source at the peak cross section (Carlos et al) the maximum specific activity of the produced sample would be 128~\si{\kilo\becquerel}/\si{\milli\gram}. Therefore, photonuclear production of $^{153}\mathrm{Sm}$ is currently below viable commercial production standards because of the low reaction cross section and flux limitations of the DIANA ICS source. However, proof-of-principle experiments could be conducted at the DIANA $\gamma$-ray ICS source.      
