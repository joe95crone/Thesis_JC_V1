...
\hline
DIANA & ERL & 2.33--20.11 & 5.77--6.08$\times 10^{11}$ \\ 
NIJI-IV \cite{sei2017demonstration} & Storage Ring & 1.2 & 3.1$\times 10^{4}$ \\ 
ELI-NP-GBS \cite{adriani2014technical} & Linac & 0.2--19.5 & $3.9\times 10^{9}$? \\
ELI-NP VEGA \cite{tanaka2020current,elinp2019vega} & Storage Ring & 1--19.5 & 1$\times 10^{11}$\\
NewSUBARU \cite{utsunomiya2015gamma} & Storage Ring & 5--40 & $3\times 10^{7}$ \\
VELOCIRAPTOR & Linac & & \\
T-REX & Linac & & \\
Pan et al CBS \cite{pan2019design} & Storage Ring & 4--10 & 0.14--3.87$\times 10^{12}$ \\ 
...
\item[$\dagger$]{The HI$\gamma$S source is capable of scattered photon energies up to 100~\si{\mega\electronvolt}. \textcolor{blue}{need to work out how to show this}}
\end{tablenotes}
\end{threeparttable}
