...
\textcolor{blue}{**TALK ABOUT CASE A OPTIMISATION**\\ **QUANTIFY EACH BENEFIT OVER TPM** \\ **BENEFIT OVER RB SOLUTION** \\ **GA VS NRB DIFFERENCE** \\ **PROFILE IS NOT ROUND**}

\textcolor{blue}{**TALK ABOUT CASE B OPTIMISATION** \\ **WHY CANT WE USE TPM AND RB** \\ **LARGER VARIABILITY BETWEEN SIMPLEX + GA - MORE COMPLEX PARAMETER SPACE?**}
...
\textcolor{blue}{**SUMMARISE POINTS: NRB BEST + NECESSARY, NRB GA BEST SOLUTION - SPEED THOUGH, ACCEPTANCE ANGLE IS ROUGHLY SAME THROUGH OPTIMISED CASES** \\ **FURTHER WORK COULD APPLY GA TO FIND CLOSE TO GLOBAL MINIMA THEN APPLY SIMPLEX TO FINE TUNE TO MINIMUM**}
