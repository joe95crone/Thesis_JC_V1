...
\textcolor{blue}{ **Add on the ICARUS data for these** // **CREATE A BENCHMARKING TABE WHICH COMPARES METHODS F0.1\%, ME, CURATOLO, SMALL ANGLE $\mathcal{F}_{\mathrm{col}} = 3/2\mathcal{F}\gamma^{2}\theta^{2}$**}
...
\textcolor{blue}{**NO SCALING FACTOR - ADDS NOTHING**}
...
\hline 
Small Angle & $7.22 \times 10^{9}$ & $3.83 \times 10^{10}$ & $8.65\times 10^{8}$ \\
Curatolo et al & $4.43 \times 10^{9}$ & $4.54\times 10^{10}$ & $6.31\times 10^{8}$ \\
Analytical & $8.86 \times 10^{8}$ & $1.04 \times 10^{10}$ & $1.17\times 10^{8}$ \\
\textsc{ICARUS} & $8.76\times 10^{8}$ & $1.04\times 10^{10}$ & $1.14\times 10^{8}$ \\
\textsc{ICCS3D} & $8.75\times 10^{8}$ & $1.02\times 10^{10}$ & $1.16\times 10^{8}$  \\
\hline\hline
\end{tabular}
\label{eq:collimated_flux_calculations}
\end{table}
