...
Optimisation of the ICS interaction allows for understanding of the best ICS source configuration for a particular experiment. Through use of tuning curves, where a Pareto front is generated in collimated flux--\textit{rms} bandwidth space, the possible configurations of an ICS source can be understood whereas in a single bandwidth point optimisation the best electron bunch and collimation settings for a particular experiment can be determined. Therefore, methods are developed to perform both tuning curve optimisations and single point optimisations.
