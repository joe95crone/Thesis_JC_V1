...
\end{figure}
\textcolor{blue}{**TALK ABOUT CASE A RB TUNING CURVES**\\}
\begin{figure}[!h]
\centering
...
\end{figure}
\textcolor{blue}{**TALK ABOUT CASE C RB TUNING CURVES**\\}
...
\textcolor{blue}{**INCLUDE THE FLUX IN A 0.1\% FWHM BANDWIDTH SCALED** }
