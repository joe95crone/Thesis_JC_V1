...
two concave reflectors and require a concentric configuration to achieve a very small beam-waist where each mirror has the same focal point and the focus is at the centre of the mirrors. Consequently, the concentric configuration is mechanically very unstable \cite{dupraz2015abcd} beacause displacements of the optical axis
