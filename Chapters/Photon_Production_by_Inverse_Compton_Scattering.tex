...
\hline
Wavelength (Photon Energy) & 10600 (0.12) & 800 (1.55) & 1064 (1.17) & 532 (2.34) & \si{\nano\meter} (\si{\electronvolt})\\
Pulse Energy & $3\times 10^{-4}$  & 0.86~\tnote{b} & $6.2\times 10^{-5}$~\tnote{c} \cite{akagi2016narrow} & $6.2\times 10^{-5}$~\tnote{c} & \si{\joule} \\
No. Photons (100~\si{\micro\joule} Pulse) & 53.3 & 4.03 & 5.34 & 2.67 & $\times 10^{14}$ \\
Pulse Duration (\textit{rms}) & 100~\tnote{d} & 0.08 & 5 & 5 & \si{\pico\second}\\
Repetition Frequency~\tnote{a} & $1.5\times 10^{4}$ & 10 & 5$\times 10^{3}$ & $5\times 10^{2}$ & \si{\hertz}\\
Spectral Bandwidth & $4.95\times 10^{-4}$ & $4.42\times 10^{-2}$ & $4.7\times 10^{-4}$ & $9.4\times 10^{-4}$ & \\
Mirror Reflectivity Coefficient & $<0.99$ & $<0.99$ \cite{thorlabs2021tisaoptics} & $<0.995$ & $<0.99$ & \\
Mirror Damage Threshold & 10 & 0.4~\tnote{e} & 20 & 0.55 & \si{\kilo\watt}/\si{\centi\meter}$^{2}$\\
\hline
\end{tabular}
\begin{tablenotes}
...
\item[e]{The damage threshold is quoted in units of \si{\joule}/\si{\centi\meter}$^{2}$ because a Ti:Sa laser is typically used for single shot ICS experiments, see data sheet \cite{thorlabs2021tisaoptics} for more details.}
\end{tablenotes}
\end{threeparttable}}
