...
\textcolor{blue}{**COMPARE CAVITY AVERAGE POWERS WITH THE 8.6W FROM TI:SA**}
...
two concave reflectors, requiring a concentric configuration to achieve a very small beam-waist, and are consequently mechanically very un-
stable \cite{dupraz2015abcd}. The concentric configuration is an extremely instable mode as displacements of the optical axis
...
The spot size at the interaction point can be made smaller be increasing the distance between the cavity mirrors 

(K Dupraz 2015 the ABCD matrix for parabolic reflectors)
% Finesse and stored power + limitations
