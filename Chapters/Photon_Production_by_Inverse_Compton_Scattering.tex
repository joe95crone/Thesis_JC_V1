...
\end{equation}
The behaviour of the total cross section as a function of electron bunch energy is shown in Fig.~\ref{} \textcolor{blue}{**PLOT REF**} 
...
\textcolor{blue}{**SHOW THE SIGMA vs SCATTERED PHOTON ENERGY PLOT**\\
**THIS NEEDS TO MENTION THAT AVERAGE ENERGY IS 2gamma2EL** \\ **HALF DIP, GEOFF HAS A FULL DERIVATION, BUT IT IS V. TRICKY**}
\begin{figure}[!h]
\centering
