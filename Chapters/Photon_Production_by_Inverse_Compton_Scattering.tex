...
\end{equation}
The behaviour of the total cross section as a function of electron bunch energy is shown in Fig.~\ref{fig:cross_section_electron_energy}.
\begin{figure}[!h]
\centering
...
\textcolor{blue}{**TALK ABOUT THE PLOTS, AROUND 90 MEV WHEN ULTRAREL IS USEFUL**}
