...
\textcolor{blue}{**START FROM FIRST PRINCIPLES** \\ **PUT IN THE POLARISATION STUFF TOO**\\ **NEED DIAGRAMS TOO + SET OUT THE CO-ORD SYSTEM BETTER**}
...
The spectral density around the Compton edge (Eq.~\ref{eq:compton_edge_energy}) in a 0.1\% FWHM bandwidth is therefore
\begin{equation}
