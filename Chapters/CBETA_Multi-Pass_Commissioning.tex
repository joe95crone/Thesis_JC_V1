...
A chromaticity script was constructed to measure the chromaticity per cell, in both planes, of sections of the FFA recirculation line, for all 4 turns. Chromaticity measurement was accomplished by recursively applying a modified version of an existing script used to measure tune in sections of the machine whilst incrementing the electron beam energy, thereby changing the electron momentum spread $\Delta p/p$.
...
up to the second turn produced usable data when this was compared to the expected tune produced from fieldmaps.
