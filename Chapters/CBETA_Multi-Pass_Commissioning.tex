...
Multi-turn energy recovery was demonstrated \cite{bartnik2020cbeta} on 24/12/2019, with 4-turns (8-passes) of the CBETA ERL using a 5~\si{\pico\coulomb} electron bunch with a 1.2~\si{\milli\meter} (4~\si{\pico\second}) bunch length (duration). Electron beam parameters measured during 4-turn operation of the CBETA ERL are tabulated in Table~\ref{tab:CBETA_ERL_commissioning_parameters}. 
