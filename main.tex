...
High quality x-ray sources are required for fundamental research in atomic physics and material science. Third generation synchrotron light sources fulfill this need in most aspects; producing a high flux (number of photons) with x-ray energies up to 100's~\si{\kilo\electronvolt} and a narrow bandwidth (energy spread). However, the maximum photon energy produced by synchrotrons is limited by facility size, electron beam energy and magnet strength constraints.
Experimentation with thick samples and some atomic physics studies require high energy x-rays. An x-ray inverse Compton scattering (ICS) source allows for production of high flux narrowband x-rays with spectral parameters between conventional bremsstrahlung x-ray sources and synchrotron light sources.  

Similarly, high quality $\gamma$-ray sources are in demand for experimentation in nuclear photonics, photonuclear radioisotope production, nuclear forensics and proliferation. Currently ICS sources, such as HI$\gamma$S, produce $\gamma$-rays with high photon fluxes and narrow bandwidths. Bremsstrahlung $\gamma$-ray sources are a viable alternative, though these are inherently broadband. Radioactive isotope sources could also be utilised however, they are typically low flux and can't be turned off. Therefore, ICS production is the premier method of $\gamma$-ray production yet, higher fluxes and narrower bandwidth ICS sources are required.

Various accelerators are capable of providing electron beams to drive ICS sources though large scattered photon fluxes are obtained with a high average electron beam current (high repetition rate and bunch charge) and small emittance, whilst narrow bandwidths require small emittance and small electron beam energy spreads. Currently, most ICS sources utilise storage rings, with high average beam current and moderate electron bunch energy spread, or linacs, with small emittance and energy spread. Energy recovery linacs (ERLs) can provide electron beams with small emittance, energy spread and high average beam current simultaneously. Hence ERLs are ideal drivers of ICS sources.     

In this thesis two ICS sources are designed: the CBETA x-ray ICS source and the DIANA $\gamma$-ray ICS source. Methods for predicting the flux and the produced photon spectrum are developed and a series of optimisations toward maximal narrowband photon production are proposed. Applications of the produced narrow-band, high energy photons are then investigated for both x-rays and $\gamma$-rays and the predicted photon production from ERL driven ICS sources is compared with other radiation production methods.   
